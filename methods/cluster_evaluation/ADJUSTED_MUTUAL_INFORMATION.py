...
def adjusted_mutual_info_eval(y_true: pd.Series, labels: pd.Series) -> float:
    """
    Compute the Adjusted Mutual Information (AMI) between true labels and cluster labels.
